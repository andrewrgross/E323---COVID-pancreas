...
fpkm.data <- read.csv('VW-10228--08--04--2020_FPKM.csv', row.names = 1)
...
### Select Columns
results <- fpkm.data ; subtitle = 'All samples';Condition = c(rep("Day 1, Mock",3), rep("Day 1, Infected",3),rep("Day3, Mock",3),rep("Day 3, Infected",3)); Condition2 = c(rep("Mock",3), rep("Day 1, Infected",3),rep("Mock",3),rep("Day 3, Infected",3)); Fill = c(rep('#a6acf7', 3),rep("#fab9b6",3),rep("#4451f2",3),rep('#fe1c1c',3))
